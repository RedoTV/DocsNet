...
{
    [DbContext(typeof(DocsNetDbContext))]
    [Migration("20250224172131_add documentMetadata to db and change relation for document ")]
    partial class adddocumentMetadatatodbandchangerelationfordocument
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.DocumentMetadata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.DocumentMetadata", b =>
                {
                    b.HasOne("Domain.Entities.Document", null)
                        ...
                        .HasForeignKey("Domain.Entities.DocumentMetadata", "DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
